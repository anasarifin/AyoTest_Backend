...
Route.get("/", assessmentController.getAllAssessmentName)
  .get("/detail/:id_assessment_name",assessmentController.getAllAssessmentNameById)
  .get("/detailbyadmin/:id_admin",assessmentController.getAllAssessmentNameByIdAdmin)
